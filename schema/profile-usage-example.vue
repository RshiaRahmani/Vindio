<template>
  <div class="max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
    ...
    <div v-else-if="profile" class="space-y-4">
      ...
      <div v-if="profile.github_link" class="flex items-center space-x-2">
    ...
    <div v-else class="text-center py-4">
      <p class="text-gray-600 dark:text-gray-400">No profile found</p>
...
<script setup>
// Import the database schema composable
...
// Export the loadProfile function so it can be called from parent components
defineExpose({
  loadProfile,
