          ...
          <div class="flex flex-col lg:flex-row items-center lg:items-start space-y-8 lg:space-y-0 lg:space-x-12">
            ...
            <div class="flex-1 text-center lg:text-left">
              <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                <div>
                  <h1 class="text-5xl font-black bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent mb-3">{{ userProfile.name || 'No name set' }}</h1>
                  <p v-if="user?.email" class="text-2xl text-gray-600 dark:text-gray-300 font-medium mb-2">{{ user.email }}</p>
          ...
          <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-[2rem] border border-white/30 dark:border-gray-700/30 p-8 shadow-xl">
            ...
            <div class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="group">
                  <label class="block text-gray-700 dark:text-gray-300 text-sm font-semibold mb-3">GitHub Profile</label>
                  <div class="relative">
                    <input 
                      v-model="userProfile.github_link"
                      :disabled="!editMode"
                      type="url" 
                      class="w-full px-6 py-4 bg-gray-50/50 dark:bg-gray-700/50 border-2 border-gray-200/50 dark:border-gray-600/50 rounded-2xl text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 focus:bg-white dark:focus:bg-gray-700 transition-all duration-300 group-hover:border-gray-300 dark:group-hover:border-gray-500"
...
const saveProfile = async () => {
  ...
  try {
    ...
    const { error: updateError } = await updateUserProfile(user.value.id, {
      ...
      github_link: userProfile.value.github_link || null
    })
