<template>
  <div class="min-h-screen">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
      <div class="absolute top-20 right-20 w-72 h-72 bg-gradient-to-br from-rose-400/20 to-pink-600/20 rounded-full blur-3xl animate-pulse"></div>
      <div class="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-tr from-purple-400/20 to-indigo-600/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
      <div class="absolute top-1/3 left-1/3 w-64 h-64 bg-gradient-to-r from-blue-400/10 to-cyan-600/10 rounded-full blur-3xl animate-pulse delay-500"></div>
    </div>
        ...
        <div class="relative p-8">
          <div class="flex flex-col lg:flex-row items-center lg:items-start space-y-8 lg:space-y-0 lg:space-x-12">
            ...
            <div class="relative group">
              <div class="relative">
                <!-- Main Avatar -->
                <div class="w-40 h-40 bg-gradient-to-br from-rose-500 via-purple-500 to-indigo-600 rounded-[2rem] flex items-center justify-center shadow-2xl transform group-hover:scale-105 transition-all duration-500 rotate-3 group-hover:rotate-0">
                  <span class="text-6xl font-black text-white">{{ getInitials(userProfile.name) }}</span>
                </div>
                
                <!-- Floating Elements -->
                <div class="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl shadow-lg animate-bounce"></div>
                <div class="absolute -bottom-3 -left-3 w-6 h-6 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-lg shadow-lg animate-pulse"></div>
                
                <!-- Edit Button -->
                <button class="absolute bottom-2 right-2 p-3 bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
            ...
            <div class="flex-1 text-center lg:text-left">
              <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                ...
                <button 
                  ...
                  class="mt-4 lg:mt-0 bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
          ...
          <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-[2rem] border border-white/30 dark:border-gray-700/30 p-8 shadow-xl">
            <div class="flex items-center justify-between mb-8">
              ...
              <button 
                v-if="editMode"
                @click="addSkill"
                class="bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-6 py-3 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                {{ $t('addSkill') }}
              </button>
            </div>
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                <span 
                  class="inline-flex items-center bg-gradient-to-r from-purple-500/20 to-indigo-500/20 text-purple-700 dark:text-purple-300 px-6 py-3 rounded-2xl font-medium border border-purple-200/50 dark:border-purple-700/50 hover:from-purple-500/30 hover:to-indigo-500/30 transition-all duration-300 transform hover:scale-105"
            ...
            <div v-if="editMode" class="mt-6">
              <div class="flex space-x-3">
                <input 
                  ...
                  type="text" 
                  class="flex-1 px-6 py-4 bg-gray-50/50 dark:bg-gray-700/50 border-2 border-gray-200/50 dark:border-gray-600/50 rounded-2xl text-gray-900 dark:text-white focus:outline-none focus:border-purple-500 transition-all duration-300"
                  :placeholder="$t('enterSkill')"
                />
                <button 
                  @click="addSkill"
                  class="bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-8 py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  {{ $t('add') }}
                </button>
              </div>
          ...
          <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-[2rem] border border-white/30 dark:border-gray-700/30 p-6 shadow-xl">
            ...
            <div class="flex flex-wrap gap-2">
              <span 
                ...
                :key="index"
                class="bg-gradient-to-r from-pink-500/20 to-rose-500/20 text-pink-700 dark:text-pink-300 px-4 py-2 rounded-xl font-medium text-sm border border-pink-200/50 dark:border-pink-700/50 hover:from-pink-500/30 hover:to-rose-500/30 transition-all duration-300 transform hover:scale-105"
              >
                {{ interest }}
              </span>
            </div>
